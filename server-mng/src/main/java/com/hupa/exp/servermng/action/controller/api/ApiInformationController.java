...
public class ApiInformationController {
    ...
    public BaseResultViaApiDto<InformationInputDto,InformationOutputDto> createOrEditInformation(
            ...
            @ApiParam(name = "title" ,value = "主键id",required =true)
            @RequestParam(name = "title") String title,
            @ApiParam(name = "cover_img" ,value = "主键id",required =true)
            @RequestParam(name = "cover_img") String coverImg,
            @ApiParam(name = "content" ,value = "主键id",required =true)
            @RequestParam(name = "content") String content,
            @ApiParam(name = "type" ,value = "主键id",required =true)
            @RequestParam(name = "type") Integer type,
            @ApiParam(name = "link_url" ,value = "主键id",required =true)
            @RequestParam(name = "link_url") String linkUrl,
            @ApiParam(name = "sort" ,value = "主键id",required =true)
